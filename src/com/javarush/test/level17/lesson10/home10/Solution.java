...
public class Solution {
    public static void main(String[] args) throws InterruptedException {
        ...
        counter4.join();
//        while (true){
//            if (counter1.isAlive() || counter2.isAlive() || counter3.isAlive() || counter4.isAlive()){
//                counter1.join();
//                counter2.join();
//                counter3.join();
//                counter4.join();
...
//            }
//        }
//        System.out.println(counter1.isAlive());
//        System.out.println(counter2.isAlive());
//        System.out.println(counter3.isAlive());
//        System.out.println(counter4.isAlive());
